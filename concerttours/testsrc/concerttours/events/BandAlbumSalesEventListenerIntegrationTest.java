...
public class BandAlbumSalesEventListenerIntegrationTest extends ServicelayerTest
{
	...
	//commented for cluster
	/*
	 * @Test public void testEventSending() throws Exception { final BandModel band =
	 * modelService.create(BandModel.class); band.setCode(BAND_CODE); band.setName(BAND_NAME);
	 * band.setHistory(BAND_HISTORY); band.setAlbumSales(MANY_ALBUMS_SOLD); modelService.save(band); final NewsModel news
	 * = findLastNews(); Assert.assertTrue("Unexpected news: " + news.getHeadline(),
